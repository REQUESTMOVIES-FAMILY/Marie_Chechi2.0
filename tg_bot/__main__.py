...
PM_START_TEXT = """
ഹായ് {}, എന്റെ പേര് [RM] Group Manager എന്നെ ഉപയോഗിക്കേണ്ടത് എങ്ങനെ ആണെന്നുള്ളതിൽ എന്തേലും സംശയം ഉണ്ടെങ്കിൽ /help കൊടുത്താൽ മതിയാകും... 
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @RM_MAINTENANCE ഇടുന്നതായിരിക്കും. സംശയങ്ങൾക്ക് @Arjuvk എന്ന വ്യക്തിയെ കാണുക.....

എന്നെ നോക്കി നടത്തുന്നത് @Arjuvk ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/REQUESTMOVIES-FAMILY/Marie_Chechi2.0) കാണാവുന്നതാണ്...
...
HELP_STRINGS = """
നമസ്കാരം ! എന്റെ പേര് [RM] Group Manager.
...
It took lots of work for [my creator](t.me/Arjuvk) to get me to where I am now, and every donation helps \
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        module = args[1].lower()
        text = "Here is the available help for the bot module:\n".format(HELPABLE[module].__mod_name__) \
               + HELPABLE[module].__help__
